      ...
      <ul class="menu-inner py-1">
          ...
          @module('view_setting')
              ...
              <li
                  ...
                  <ul class="menu-sub">
                        <li
                          class="menu-item {{ Request::is('support/create') ? 'active' : '' }}">
                          <a href="{{ url('support/create') }}" class="menu-link">
                              <div data-i18n="Create">Create</div>
                          </a>
                      </li>
                        <li
                          class="menu-item {{ Request::is('supports') ? 'active' : '' }}">
              ...
              {{-- <li
              class="menu-item {{ Request::is('supports') || Request::is('support/details/*') || Request::is('support/create') ? 'active' : '' }}">
              <a href="{{ url('supports') }}" class="menu-link">
                  <i class="ti ti-message-dots me-2 ti-sm"></i>
                  <div data-i18n="Support">Support</div>
              </a>
