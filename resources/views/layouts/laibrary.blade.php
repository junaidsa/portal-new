          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            <div class="navbar-brand-box">
              <a href="" class="logo logo-dark">
                <span class="logo-lg">
                  <img src="{{asset('public')}}/assets/img/branding/logo.png" class="" alt="" height="40">
                </span>
              </a>
            </div>
    ...
    <footer class="footer bg-dark mb-4" style="border-radius: 0.4rem;">
      <div class="container-fluid text-center container-p-x py-3">
        <div class="text-light ">
          ...
          , made with ❤️ by <a href="https://www.facebook.com/queryprovider" target="_blank" class="fw-semibold">Query
            Provider</a>
        </div>
      </div>
    </footer>
