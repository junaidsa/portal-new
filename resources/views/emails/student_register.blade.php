...
<body
    ...
    <div
        ...
        <div style="padding: 20px 30px;">
            ...
            <p style="font-size: 14px; color: #636e77; line-height: 1.6; text-align: center; margin-bottom: 20px;">A new Student account has been created with the following details:</p>
