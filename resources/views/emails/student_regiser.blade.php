...
<v:fill type="tile" color="#008bf7"></v:fill>
</v:background>
<![endif]-->
...
style="background-color: #ffffff; border-radius: 15px 15px 0px 0px;">
...
style="font-size: 0px;"><a
    target="_blank"><img
        src="https://smartedu.my/wp-content/uploads/2024/03/Logo-white-background-296x99.png"
        alt="Company Logo"
        style="display: block;"
        width="140"></a></td>
</tr>
...
style="font-size: 0px;"><a
    target="_blank"><img
        class="adapt-img"
        src="public/assets/img/branding/lineu.png"
        alt
        style="display: block;"
        width="600"></a></td>
</tr>
...
<tr>
<td class="esd-structure es-p25t es-p10b es-p25r es-p25l"
align="left" bgcolor="#ffffff"
style="background-color: #ffffff;"
esd-custom-block-id="597528">
<table width="100%" cellspacing="0" cellpadding="0">
<tbody>
<tr>
<td class="esd-container-frame" width="550"
...
<p>A new student account has been
    created with the following
    details:</p>
<p>Please log in and change your
...
<p>If you have any issues,
    ...
    team.</p>
<br>
<a href="{{ $loginUrl }}" class="btn-submit">Login</a>
</td>
...
<tr>
<td class="esd-structure es-p15t es-p30b es-p25r es-p25l"
align="left" bgcolor="#ffffff"
style="background-color: #ffffff; border-radius: 0px 0px 15px 15px;"
esd-custom-block-id="597529">
...
<tr>
<td align="left"
class="esd-block-text es-p20t es-m-p10t">
<p style="color: #990000;">
    <strong><a
            href="https://smartedu.my/"
            target="_blank">https://smartedu.my/</a></strong>
</p>
</td>
</tr>
</tbody>
...
style="font-size: 0px;"><a
    target="_blank"><img
        src="public/assets/img/branding/hartua.png"
        alt
        style="display: block;"
        width="84"></a>
</td>
    ...
    <tbody>
        <tr>
            <td align="center"
                valign="top"
                class="es-p10r">
                <a href="https://www.smartedu.my"
                    target="_blank"
                    style="background: #fff; border-radius: 50%; display: inline-block;"><img
                        src="https://app.smartedu.my/public/img/www.png"
                        width="40"
                        height="40"
                        alt="Website"></a>
            </td>
            <td align="center"
                ...
                <a href="https://www.facebook.com/www.smartedu.my"
                    target="_blank"><img
                        src="https://app.smartedu.my/public/img/fb.png"
                        width="40"
                        height="40"
                        alt="Facebook"></a>
            </td>
            <td align="center"
                ...
                <a href="https://www.instagram.com/smartedu.my/"
                    target="_blank"><img
                        src="https://app.smartedu.my/public/img/instagram.png"
                        width="40"
                        height="40"
                        alt="Instagram"></a>
            </td>
            <td align="center"
                valign="top"
                class="es-p10r">
                <a href="https://x.com/SmartEdumy"
                    target="_blank"><img
                        src="https://app.smartedu.my/public/img/twitter.png"
                        width="40"
                        height="40"
                        alt="Twitter"></a>
            </td>
            <td align="center"
                valign="top"
                class="es-p10r"
                style="border-radius: 40rem; overflow: hidden;">
                <a href="https://www.linkedin.com/in/smarteducationmy/"
                    target="_blank"
                    style="background: #fff; border-radius: 50%; display: inline-block;"><img
                        src="https://app.smartedu.my/public/img/linkdin.png"
                        width="40"
                        height="40"
                        alt="LinkedIn"></a>
            </td>
            <td align="center"
                ...
                <a href="https://www.pinterest.com/SmartEducationMy/"
                    target="_blank"><img
                        src="https://app.smartedu.my/public/img/pinterest.png"
                        width="40"
                        height="40"
                        alt="Pinterest"></a>
            </td>
            <td align="center"
                ...
                <a href="https://www.tiktok.com/@smartedu.my"
                    target="_blank"><img
                        src="https://app.smartedu.my/public/img/tiktok.png"
                        width="40"
                        height="40"
                        alt="TikTok"></a>
            </td>
...
<tr>
<td align="center"
class="esd-block-text es-p15t">
<p style="margin-top: 1rem;">©
    2024 SmartEdu, All rights
    reserved.</p>
</td>
</tr>
</tbody>
