    ...
    <div
        ...
        <div style="padding: 20px 30px;">
            <h1 style="font-size: 22px; color: #2d3e50; font-weight: 600; text-align: center; margin-bottom: 10px;">
                Welcome to Smart Education!</h1>
            <p style="font-size: 14px; color: #636e77; line-height: 1.6; text-align: center; margin-bottom: 20px;">A new
                admin account has been created. Below are your login details.</p>
            <p style="font-size: 14px; color: #636e77; line-height: 1.6; text-align: center; margin-bottom: 20px;">
                Please log in and change your password immediately for security reasons.  Contact on <a href="https://wa.me/message/U2Y4YU5ZDNEQN1"> WhatsApp</a></p>

            <!-- Account Details Section -->
            <div
                style="background-color: #f8f9fa; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #e0e3e7;">
                <p style="font-size: 14px; color: #2d3e50; margin: 8px 0;"><strong>Full Name:</strong>
                    {{ $name }}</p>
                <p style="font-size: 14px; color: #2d3e50; margin: 8px 0;"><strong>Email:</strong> {{ $email }}
                </p>
                <p style="font-size: 14px; color: #2d3e50; margin: 8px 0;"><strong>Branch:</strong> {{ $branch }}
                </p>
                <p style="font-size: 14px; color: #2d3e50; margin: 8px 0;"><strong>Password:</strong>
                    {{ $password }}</p>
            </div>
            ...
            <p style="text-align: center;">
                <a href="https://yourwebsite.com"
                    style="background-color: #47a2ff; color: white; padding: 12px 26px; font-size: 14px; text-decoration: none; border-radius: 6px; font-weight: 500; display: inline-block; transition: background-color 0.3s ease;">Verify
                    Your Account</a>
            </p>
        </div>
