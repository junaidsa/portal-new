                                    ...
                                    <td class="esd-stripe" align="center">
                                        <table class="es-header-body" width="600" cellspacing="0" cellpadding="0" align="center" style="background-color: transparent; ">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p35t es-p35b es-p20r es-p20l" align="left" bgcolor="#ffffff" style="background-color: #ffffff; border-radius: 15px 15px 0px 0px;">
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="560" align="left">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img src="https://smartedu.my/wp-content/uploads/2024/03/Logo-white-background-296x99.png"  alt="Company Logo" style="display: block;" width="140"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td width="600" class="esd-container-frame" align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="public/assets/img/branding/lineu.png" alt style="display: block;" width="600"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                    ...
                                    <td class="esd-stripe" align="center">
                                        <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" align="center" style="background-color: transparent;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p25t es-p10b es-p25r es-p25l" align="left" bgcolor="#ffffff" style="background-color: #ffffff;" esd-custom-block-id="597528">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="550" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <h1>Teacher Account Created</h1>
                                                                                    <td  class="esd-block-text es-p10t">
                                                                                        <p>A new teacher account has been created with the following details:</p>
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p15t es-p30b es-p25r es-p25l" align="left" bgcolor="#ffffff" style="background-color: #ffffff; border-radius: 0px 0px 15px 15px;" esd-custom-block-id="597529">
                                                                ...
                                                                <tr>
                                                                    <td width="264" class="es-m-p20b esd-container-frame" align="left">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p20t es-m-p10t">
                                                                                        <p style="color: #990000;"><strong><a href="https://smartedu.my/" target="_blank">https://smartedu.my/</a></strong></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                ...
                                <tr>
                                    <td class="esd-stripe" align="center">
                                        <table class="es-footer-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p35t es-p35b es-p20r es-p20l" align="left">
                                                        <table cellspacing="0" cellpadding="0" width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="560" align="left">
