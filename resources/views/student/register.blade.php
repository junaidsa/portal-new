                ...
                <div id="personal-details" class="content">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="studentremark" id="studentremark" cols="" rows="3" class="form-control"></textarea>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label"
                                for="Please Select Your Level | Registration &
                Material Fees">Please
                                Select Your Level | Registration &
