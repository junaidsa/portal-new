                    ...
                    <div class="card-body">
                        <form action="{{ url('/tuition/update') }}" method="POST" id="adminForum">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <input type="hidden" value="{{$tuition->id}}" name="id">
                                        <label for="name" class="form-label">Name <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name"
                                            placeholder="Enter Full Name"value="{{ $tuition->name }}" />
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('type') is-invalid @enderror" id="type"
                                            ...
                                            <option value="1-1 Online" {{ $tuition->type == '1-1 Online' ? 'selected' : '' }}>1-1 Online</option>
                                            <option value="1-1 Home" {{ $tuition->type == '1-1 Home' ? 'selected' : '' }}>1-1 Home</option>
                                            <option value="Online Group" {{ $tuition->type == 'Online Group' ? 'selected' : '' }}>Online Group</option>
                                            <option value="Physical" {{ $tuition->type == 'Physical' ? 'selected' : '' }}>Physical</option>
                                        </select>
                                        @error('type')
                                            <div class=" invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="status" name="status"
                                            ...
                                            <option value="1" {{ $tuition->status == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ $tuition->status == 0 ? 'selected' : '' }}>Deactive</option>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select  @error('branch') is-invalid @enderror" id="branch"
                                            ...
                                            @foreach ($branch as $b)
                                                <option value="{{ $b->id }}"
                                                    {{ $tuition->branch_id == $b->id ? 'selected' : '' }}>
                                                    {{ $b->branch }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('price') is-invalid @enderror"
                                            id="price" name="price"
                                            placeholder="Enter Price"value="{{ $tuition->price }}" />
                                        @error('price')
                                            <div class=" invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('price') is-invalid @enderror"
                                            id="year" name="year"
                                            placeholder="Enter Year"value="{{ $tuition->year }}" />
                                    </div>
                                </div>
