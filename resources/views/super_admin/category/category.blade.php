...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
      <div class="card-header d-flex justify-content-between"><h5>Responsive Datatable</h5> <div class="btn-container"><a href="{{url('category/create')}}" class="btn btn-success">Create Category</a></div></div>
