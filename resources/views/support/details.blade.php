...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row"> <!-- Timeline Advanced-->
            <div class="col-xl-12">
                <div class="card">
                            ...
                            <li class="timeline-item timeline-item-danger pb-4 border-left-dashed">
                                ...
                                <div class="timeline-event">
                                    <div class="d-flex flex-sm-row flex-column">
                                        <img src="../../assets/img/elements/11.jpg" class="rounded mb-sm-0 mb-3 me-3"
                                            alt="Shoe img" height="62" width="62" />
                                        <div>
                                            ...
                                            <p>
                                                PUMA presents the latest shoes from its collection. Light & comfortable made
                                                with
