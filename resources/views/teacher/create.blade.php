                    ...
                    <form id="teacher_forum" action="{{ url('teacher/store') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="text" name="availability" id="availability" class="form-control @error('availability') is-invalid @enderror" placeholder="09:00am to 10:00pm">
                                @error('availability')
                                    <div class=" invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="bank_info" class="form-label">Bank Infomation <span
                                            class="text-danger">*</span></label>
                                    <input type="text"
                                        class="form-control  @error('payment_information') is-invalid @enderror"
                                        id="payment_information" name="payment_information"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="city" class="form-label">City <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('city') is-invalid @enderror" id="city" name="city" placeholder="Enter Your City">
                                    @error('city')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
